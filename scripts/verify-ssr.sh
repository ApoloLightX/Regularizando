...
check "/"                              "Veja a pendência antes que ela vire retrabalho." "Regularizando"
check "/produto"                       "O fluxo verificável" "Plataforma de Gestão Ambiental"
check "/casos-de-uso"                  "Cada função enxerga o mesmo fato por uma lente operacional." "Regularizando para Telecom"
check "/piloto-telecom"                "Uma prova de valor que a equipe consegue medir." "Piloto"
check "/seguranca"                     "O que sua equipe consegue verificar hoje." "Segurança e governança"
check "/contato"                       "Comece pelo risco que sua equipe precisa" "Solicitar piloto"
# Rotas privadas permanecem fora do índice e não são verificadas como conteúdo público.
# Redirect layer — one row per class (every conversão has the first two):
check_301 "/index.html"                "/"
check_301 "/produto/"                  "/produto"
