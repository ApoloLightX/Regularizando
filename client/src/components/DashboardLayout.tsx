...
import { BookOpenCheck, ClipboardCheck, ContactRound, FileSearch, FileUp, LayoutDashboard, LogOut, PanelLeft, Route, ShieldCheck, TowerControl, UsersRound } from "lucide-react";
...
const menuItems = [
  ...
  { icon: ShieldCheck, label: "Governança LGPD", path: "/governanca-lgpd" },
        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-6">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-sm">
              O painel de dados é protegido e usa a autenticação segura da plataforma.
            </p>
          </div>
          <Button
            onClick={() => startLogin()}
  ...
  return (
    <>
      <div className="relative" ref={sidebarRef}>
        <Sidebar
          collapsible="icon"
          className="border-r-0 regularizando-sidebar"
          ...
          <SidebarHeader className="h-16 justify-center">
            <div className="flex items-center gap-3 px-2 transition-all w-full">
              ...
              <div className="sidebar-brand min-w-0">
                <BrandMark />
                {!isCollapsed ? <span>regularizando</span> : null}
              </div>
            </div>
          </SidebarHeader>
